    ...
    <>
      <div className="pb-[40px] md:pb-[80px] lg:pb-[100px]  bg-white">
        <div
          ...
          id="syllabus"
        >
          <h2 className="merriweather-font font-normal  text-2xl md:text-3xl lg:text-4xl mb-6 lg:mb-[36px] text-[#1E1E1E]  tracking-[-0.04em] text-center">
            Syllabus
          </h2>
          ...
          <table className="w-full ">
            <thead>
              <tr className="bg-[#36C9B4]">
                <td
                  width={81}
                  className="text-white text-sm px-3.5 py-5 tracking-[-0.04em] uppercase"
                >
                  Sr. No.
                </td>
                <td className="text-white text-sm px-3.5 lg:px-[30px] py-5 tracking-[-0.04em] uppercase">
                  Grade
                </td>
                <td className="text-white text-sm px-3.5 lg:px-[30px] py-5 tracking-[-0.04em] uppercase">
                  Download
