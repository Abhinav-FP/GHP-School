...
export default function index() {
    return (
        <> 
            ...
            <div style={{ backgroundImage: `url(${AcademicBg.src})` }} className=' bg-no-repeat bg-center bg-cover pt-[102px] md:pt-[152px] md:pt-[195px] pb-[70px]  md:pb-[100px] lg:pb-[132px]'>                 
