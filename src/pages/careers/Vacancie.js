...
function Vacancie() {
    ...
    const VacancieList = [
        {
            title: "Arts Teacher",
            decription: "BVBS School is looking for an enthusiastic Art Teacher with 1-2 years of experience to inspire students’ creativity and artistic skills.",
            exp: "1-2 Years Experience",
            qualification: "B.Ed. in Arts",
        },
        {
            title: "English Teacher",
            decription: "BVBS School is seeking a dynamic English Teacher with 3-4 years of experience to engage students and enhance their language skills.",
                        ...
                        <div className="bg-[#ECE1C5] p-6 lg:p-10" key={index}>
                            <div className="flex flex-wrap -mx-3 lg:-mx-6.5 items-center">
                                <div className="w-full lg:w-9/12 px-3 lg:px-6 mb-6 lg:mb-0"> 
                                    <h2 className="text-left merriweather-font font-normal text-xl  lg:text-2xl mb-2 text-[#1E1E1E] tracking-[-0.04em]">{item.title}</h2>
                                    <p className="tracking-[-0.04em] mx-auto text-[#666666] text-base font-medium mb-4 lg:mb-6 ">{item.decription}</p>
                                    <div className="pt-4 lg:pt-6 border-t border-opacity-10 border-black">
                                         <div className="tracking-[-0.04em] text-[#666666] text-sm font-medium mb-0">
                                            <span>{item.exp}</span> &nbsp; | &nbsp; <span>{item.qualification}</span>
                                         </div>
                                    </div>
                                </div>
