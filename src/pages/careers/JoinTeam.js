  ...
  return (
    <div className="bg-white py-[40px] md:py-[80px] lg:py-[100px]">
      <div className="container sm:container md:container lg:max-w-[1232px] px-4 mx-auto">
        <h2 class="merriweather-font font-normal text-2xl md:text-3xl lg:text-4xl mb-2.5 text-[#1E1E1E] tracking-[-0.04em] text-center">
          ...
          <div className="py-6 lg:py-[30px] px-[20px] lg:px-[40px]">
            <div className="flex -mx-2.5 flex-wrap">
              <div className="w-full md:w-6/12 px-2.5 mb-4 lg:mb-6">
                <label class="inline-block text-base text-[#1E1E1E] tracking-[-0.04em] opacity-80 mb-2 lg:mb-2.5 uppercase">
                  Name<em className="text-[#FF5400]">*</em>{" "}
                </label>
                <input
                  type="text"
                  class="border border-black border-opacity-10 px-3.5 py-2 w-full appearance-none h-11 lg:h-[54px] text-[#1E1E1E] tracking-[-0.04em] leading-tight focus:outline-none"
                />
              </div>
              <div className="w-full md:w-6/12 px-2.5 mb-4 lg:mb-6">
                <label class="inline-block text-base text-[#1E1E1E] tracking-[-0.04em] opacity-80 mb-2 lg:mb-2.5 uppercase">
              ...
              <div className="w-full md:w-12/12 px-2.5 mb-4 lg:mb-6">
                ...
                <input
                  type="file"
                  class="bg-white border border-black border-opacity-10 px-3.5 py-2 w-full appearance-none h-11 lg:h-[54px] text-[#1E1E1E] tracking-[-0.04em] leading-tight focus:outline-none"
                />
              </div>
              <div className="w-full md:w-12/12 px-2.5 mb-4 lg:mb-6">
                <label class="inline-block text-base text-[#1E1E1E] tracking-[-0.04em] opacity-80 mb-2 lg:mb-2.5 uppercase">
                ...
                <textarea
                  type="file"
                  class="bg-white border border-black border-opacity-10 px-3.5 py-2 w-full appearance-none h-11 lg:h-[139px] text-[#1E1E1E] tracking-[-0.04em] leading-tight focus:outline-none"
                ></textarea>
              </div>
              ...
              <div className="w-full md:w-6/12 px-2.5 mb-4 lg:mb-0 lg:text-right">
                <button
                  type="submit"
                  class="bg-[#EE834E] lg:min-w-[253px] text-center hover:bg-[#ECCD6E] rounded px-8 lg:px-12 py-2 lg:py-3.5 text-white text-base lg:text-lg font-normal tracking-[-0.04em]"
                  fdprocessedid="1gg5s"
                >
                  Submit
                </button>
