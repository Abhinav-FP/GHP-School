            ...
            <div className="px-4 py-2 lg:px-10 lg:py-2.5">
              <div className="bg-white rounded-[20px] mb-[30px]">
                <div className="py-3 py-4 lg:py-[23px] px-4 md:px-6 lg:px-10 flex flex-wrap justify-between listings-center border-b border-black border-opacity-10">
                  <h3 className="text-lg lg:text-xl merriweather-font font-normal text-[#1E1E1E] mb-3 sm:mb-0 tracking-[-0.03em]">
                    Admission
                  </h3>
                </div>
                    ...
                    <table className="min-w-full">
                      <thead>
                        <tr className="bg-[#36C9B4] text-white">
                          <th className="whitespace-nowrap pl-4 md:pl-6 lg:pl-10 pr-3 py-3 lg:py-3.5 text-sm font-medium  text-left uppercase tracking-[-0.03em]  text-white ">
                            Form No.
                          </th>
                          <th className="pl-4 md:pl-6 lg:pl-10 pr-3 py-3 lg:py-3.5 text-sm font-medium  text-left uppercase tracking-[-0.03em]  text-white ">
                            Name
                          </th>
                          <th className="pl-4 md:pl-6 lg:pl-10 pr-3 py-3 lg:py-3.5 text-sm font-medium  text-left uppercase tracking-[-0.03em]  text-white ">
                            DOB
                      ...
                      <tbody>
                        {listing.map((item, index) => (
                          <tr
                            key={index}
                            className="bg-white border-t border-black border-opacity-10 transition duration-300 ease-in-out hover:bg-gray-100"
                          >
                            <td className="whitespace-nowrap pl-4 md:pl-6 lg:pl-10 pr-3 py-4 text-[15px] font-medium text-[#666666] tracking-[-0.03em]">
                              {index < 9 ? `E0${index + 1}` : `E${index + 1}`}{" "}
                            </td>
