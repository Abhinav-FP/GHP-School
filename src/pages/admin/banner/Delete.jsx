...
function Delete({ srNo, BannerGetData }) {
    ...
    const handleClick = (e) => {
        ...
        const response = main.BannerDelete({ srNo: srNo });
        response
            .then((res) => {
                if (res && res?.data) {
    ...
    return (<>
        <button
            ...
            className="text-[#fff] h-[30px] w-[30px] bg-[#ff0000] bg-opacity-80 hover:bg-opacity-100 rounded inline-flex items-center justify-center"
        >
