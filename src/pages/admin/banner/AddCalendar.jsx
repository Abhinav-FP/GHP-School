...
export default function AddAcademy({ item, getNotificationdata }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res =
                item?._id ? await main.AcademyEdit(formdata) : await main.AcadmeyAdd(formdata);
            if (res?.data) {
                ...
                <Modal isOpen={isOpen} onClose={handleClose}>
                    <div className="relative bg-white w-full rounded-[30px] lg:rounded-[40px] h-auto m-auto">
                        <div className="border-b border-black border-opacity-10 pt-6 pb-5 px-6 lg:pt-8 lg:pb-6 lg:px-10">
                            <h2 className="text-xl lg:text-2xl  text-[#212121] tracking-[-0.04em] font-semibold mb-0">Manage Academcies Calendar
                            </h2>
                        </div>
