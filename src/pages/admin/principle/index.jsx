...
function Index() {
    ...
    const handleSubmit = (e) => {
        ...
        data.append("test", formdata.text);
        data.append("photo", formdata.photo);
        const response = main.addprinciple(data);
        ("response",response);
        response
          .then((res) => {
                    ...
                    <div className="bg-white rounded-[20px] mb-[30px]">
                        <div className="py-3 py-4 lg:py-[23px] px-4 md:px-6 lg:px-10 flex flex-wrap justify-between items-center border-b border-black  border-opacity-10">
                            ...
                            <div className="flex items-center space-x-2 ">
                                <button onClick={handleOpen} className="text-white bg-[#0367F7] hover:text-[#0367F7] hover:bg-white text-sm font-normal tracking-[-0.03em] py-2 px-3 xl:px-3.5 border border-[#0367F7] rounded-md outline-none focus:outline-none ease-linear transition-all duration-150">
                                    Add New Principle
                                </button>
                                ...
                                <table className="min-w-full">
                                    ...
                                    <tbody>
                                        <tr className="bg-white border-t transition duration-300 ease-in-out hover:bg-gray-100">
                                            ...
                                            <td className="pl-4 md:pl-6 lg:pl-10 pr-3 py-4 text-[15px] font-medium text-[#46494D] tracking-[-0.03em]">
                                                <Image width={"400"} height={"200"} src={listing?.photo} alt={listing?.name} />
                                            </td>
                                            <td className="pl-4 md:pl-6 lg:pl-10 pr-3 py-4 text-[15px] font-medium text-[#46494D] tracking-[-0.03em]">
                                                {listing?.name}
                                            </td>
                                            ...
                                            <td className="px-3 py-4 text-[15px] font-medium text-[#46494D] text-center tracking-[-0.03em] space-x-2">
                                                <div className="flex space-x-2 justify-center">
                                                    {/* <Edit step={3} item={item} states={State}  />
                                                        {item?.uuid &&
                                                        } */}
                                                    <button
                                                        onClick={handleOpen}
            ...
            <Modal isOpen={isOpen} onClose={handleClose}>
                ...
                <div className="relative bg-white w-full rounded-[30px] lg:rounded-[40px] h-auto m-auto">
                    ...
                    <div className="border-b border-black border-opacity-10 pt-6 pb-5 px-6 lg:pt-8 lg:pb-6 lg:px-10">
                        <h2 className="text-xl lg:text-2xl  text-[#212121] tracking-[-0.04em] font-semibold mb-0">Add New Principle </h2>
                    </div>
                        ...
                        <form>
                            ...
                            <div className="flex justify-end pt-3 px-6 lg:px-10 ">
                                <button type="submit"
                                    ...
                                    {Loading ? "Processing.." : "Add New Principle"}
