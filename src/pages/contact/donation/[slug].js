          ...
          <div className='flex flex-wrap -mx-5 items-center'>
            <div className='w-full md:w-6/12 px-5'>
              <div className='bg-[#f9f9f9] h-[580px] flex items-center justify-center'>
                <Image src={ProductImg} alt="Img"></Image>
              </div>
            </div>
            <div className='w-full md:w-6/12 px-5'>
              <h1 className='merriweather-font font-normal  text-2xl md:text-3xl lg:text-4xl mb-4 lg:mb-6 text-[#1E1E1E]  tracking-[-0.04em]'>Tuition Fees </h1>
              <div className='text-[#EE834E] text-lg font-medium tracking-[-0.04em] uppercase mb-0'>
                AMOUNT : ₹ <span>11,100</span>
              </div>
              <div className='mt-5 lg:mt-[30px] mb-8 lg:mb-10 pt-5 lg:pt-[30px]  border-t border-black border-opacity-10'>
                <p className='text-[#666666] font-medium text-base gotham-font mb-0 tracking-[-0.04em]'>Sponsor a child’s entire education for one academic year, covering tuition and giving them the foundation for a brighter future.</p>
              </div>
              <div className='flex mb-4 lg:mb-6 '>
                <div className='min-w-[140px] flex border border-[#EE834E] rounded mr-4 lg:mr-[23px] py-[12px] justify-center items-center'>
                  <button className='text-[#EE834E] font-medium text-2xl tracking-[-0.04em]' onClick={decrement}>-</button>
                  <div className='text-[#EE834E] font-medium text-lg text-center w-[50px] mx-3.5 border-l border-r border-black border-opacity-10 py-[2px] tracking-[-0.04em]'>{Qty}</div>
              ...
              <div className='w-full flex flex-wrap items-center'>
                ...
                <ul className='flex flex-wrap items-center space-x-3'>
                  ...
                  <li>
                    <Link href="/" className="">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.5 8C15.5 3.86 12.14 0.5 8 0.5C3.86 0.5 0.5 3.86 0.5 8C0.5 11.63 3.08 14.6525 6.5 15.35V10.25H5V8H6.5V6.125C6.5 4.6775 7.6775 3.5 9.125 3.5H11V5.75H9.5C9.0875 5.75 8.75 6.0875 8.75 6.5V8H11V10.25H8.75V15.4625C12.5375 15.0875 15.5 11.8925 15.5 8Z" fill="#1E1E1E" fill-opacity="0.8" />
                      </svg>
                    </Link>
                  </li>
                  <li>
