            ...
            <div className="w-full md:w-6/12 px-5">
              ...
              <div className="mt-5 lg:mt-[30px] mb-8 lg:mb-10 pt-5 lg:pt-[30px]  border-t border-black border-opacity-10">
                <p className="text-[#666666] font-medium text-base gotham-font mb-0 tracking-[-0.04em]">
                  Sponsor a child’s entire education for one academic year,
                  covering tuition and giving them the foundation for a brighter
                  future.
                </p>
              </div>
              <div className="flex mb-4 lg:mb-6 ">
                ...
                <div className="w-full">
                  <button
                    className="block w-full text-[#EE834E] hover:bg-[#EE834E] hover:text-white border border-[#EE834E] text-base lg:text-lg rounded px-4 py-3.5 text-center tracking-[-0.04em]"
