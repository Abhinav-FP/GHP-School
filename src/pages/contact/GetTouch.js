...
import MapImage from '../../../public/Contacts/Mapimage.png';
            ...
            <div className='container sm:container md:container lg:max-w-[1232px] px-4 mx-auto'>
                <div className='flex flex-wrap items-center -mx-4'>
                    <div className='w-full lg:w-6/12 px-4 mb-6 lg:mb-0'>
                        ...
                        <h3 className='merriweather-font font-normal uppercase tracking-[-0.04em] text-xl lg:text-2xl text-[#1E1E1E] mb-4 lg:mb-5'>BAL VISHWA BHARTI PUBLIC SR SEC SCHOOL</h3>
                        <div className='space-y-2.5'>
                            <p className='relative pl-6 text-[#1E1E1E] opacity-80 tracking-[-0.04em] text-base font-medium gotham-font'><IoCallOutline size={18} className='absolute left-0 top-1/2 -translate-y-1/2' />
                            ...
                            <p className='relative pl-6 text-[#1E1E1E] opacity-80 tracking-[-0.04em] text-base font-medium gotham-font'><CiMail className='absolute left-0 top-1/2 -translate-y-1/2' size={18}  />
                            ...
                            <p className='relative pl-6 text-[#1E1E1E] opacity-80 tracking-[-0.04em] text-base font-medium gotham-font'>
                                <a href="https://www.google.com/maps/dir//D,+74,+Ghiya+Marg,+Sindhi+Colony,+Bani+Park,+Jaipur,+Rajasthan+302032+@26.931568,75.791982/@27.7436422,76.5794786,7z/data=!4m7!4m6!1m1!4e2!1m2!1m1!1s0x396db3efafa594ef:0x2da3b3ab79a793f4!3e0">
                                    <CiLocationOn size={18}  className='absolute left-0 top-1/2 -translate-y-1/2' /> D-74, Ghiya Marg, Bani Park, Jaipur, Rajasthan 302016
                                </a>
                            </p>
                        </div>
                    </div>
