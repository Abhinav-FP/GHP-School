      ...
      <div className="container sm:container md:container lg:max-w-[1232px] px-4 mx-auto">
        ...
        <div className="flex flex-wrap -mx-4 items-center">
          <div className="w-full md:w-6/12 px-4 ">
            <Image className="max-w-full block mx-auto mb-3 md:mb-0"  alt={listing?.name} src={listing?.photo} height={400} width={307} />
          </div>
          <div className="w-full md:w-6/12 px-4">
            <p className="text-[#666666] font-medium text-base gotham-font mb-5 lg:mb-[28px] tracking-[-0.04em] "><q>{listing?.text}</q></p>
