    ...
    <div className='relative'>
      ...
      <div className="absolute h-full flex items-center left-0 w-full top-1/2 -translate-y-1/2 bg-black bg-opacity-30 ">
        <div className="mx-auto container sm:container md:container lg:max-w-[1232px] px-4 text-center">
          <h2 className="capitalize merriweather-font font-normal text-xl sm:text-2xl md:text-4xl lg:text-[60px] mb-0 text-[#ECE1C5] tracking-[-0.04em] ">gopal sharma memorial school
          ...
          <span className="capitilaze text-white block mt-3 ">Admission Starting Soon</span>
          </h2>
        </div>
      </div>
    </div>   
