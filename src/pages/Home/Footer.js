  ...
  return (
    <>
          ...
          <div className="flex flex-wrap -mx-2">
            <div className="w-full lg:w-7/12 px-2 mb-6 lg:mb-0">
              ...
              <div className="space-y-2.5 text-center  md:text-left flex md:block justify-center flex-col items-center">
                <p className="min-w-[200px] flex-wrap justify-center sm:min-w-[420px] flex md:block relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                  <IoCallOutline className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 inline align-text-top mr-2 md:mr-0" />
                ...
                <p className="min-w-[200px] flex-wrap justify-center sm:min-w-[420px] flex md:block relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                  <CiMail className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 inline align-text-top mr-2 md:mr-0 mt-[3px] md:mt-0" />
                ...
                <p className="min-w-[200px] flex-wrap justify-center sm:min-w-[420px] flex md:block relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                  ...
                  >
                    <CiLocationOn className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 align-text-top inline mr-2 md:mr-0" />{" "}
            ...
            <div className="w-full md:w-6/12 lg:w-2/12 px-2 mb-6 md:mb-0">
              ...
              <div className="space-y-2.5 text-center md:text-left flex md:block justify-center flex-col items-center">
                <p className="min-w-[180px] flex  relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                  <Link
                    href="/careers"
                    className="text-[#1E1E1E] hover:text-[#EE834E]"
                  >
                    <svg
                      className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 align-text-top inline mr-2 md:mr-0"
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
                      fill="none"
                ...
                <p className="min-w-[180px] flex  relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                  <Link
                    ...
                    className="text-[#1E1E1E] hover:text-[#EE834E]"
                  >
                    <BiDonateHeart className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 align-text-top inline mr-2 md:mr-0" />{" "}
                    Sponsor/ Donations
                  </Link>
                </p>
                <p className="min-w-[180px] flex  relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                  <Link
                    ...
                    className="text-[#1E1E1E] hover:text-[#EE834E]"
                  >
                    <LuSchool className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 align-text-top inline mr-2 md:mr-0" />{" "}
                    Infrastructure
                  </Link>
                </p>
              </div>
            ...
            <div className="w-full md:w-6/12 lg:w-3/12 px-2 md:flex md:justify-end">
              <div>
                ...
                <div className="space-y-2.5 text-center md:text-left flex md:block justify-center flex-col items-center">
                  <p className="w-[160px] flex relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                    <a  href="https://www.facebook.com/profile.php?id=61557061876412" target="blank" className="text-[#1E1E1E] hover:text-[#EE834E]">
                      <FaFacebook className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 align-text-top inline mr-2 md:mr-0" />{" "}
                      Bal Vishwa Bharti
                    </a>
                  </p>
                  <p className="w-[160px] flex relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                    <a href="https://www.instagram.com/bvbschool?igsh=ZTR5ZWl3bmdjYThv" target="blank" className="text-[#1E1E1E] hover:text-[#EE834E]">
                      <IoLogoInstagram className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 align-text-top inline mr-2 md:mr-0" />{" "}
                      @bvbschool
                    </a>
                  </p>
                  <p className="w-[160px] flex relative md:pl-6 text-[#1E1E1E] opacity-90 tracking-[-0.04em] text-sm md:text-base font-medium gotham-font">
                    <a href="https://www.youtube.com/@bvbschool-t9z" target="blank" className="text-[#1E1E1E] hover:text-[#EE834E]">
                      <AiOutlineYoutube className="md:absolute left-0 md:top-1/2 md:-translate-y-1/2 align-text-top inline mr-2 md:mr-0" />
                      @bvbschool-t9z
                    </a>
                  </p>
                </div>
      ...
      <div className="z-[1] relative bg-[#FCFBF4] border-t border-black border-opacity-10 py-5">
        <div className="container sm:container md:container lg:max-w-[1204px] px-4 mx-auto">
          <p className="text-[#1E1E1E] opacity-50 tracking-[-0.04em] font-medium text-center text-sm md:text-base">
